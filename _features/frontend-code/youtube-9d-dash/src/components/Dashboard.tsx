...
const DashboardContent = () => {
  ...
  return (
    <>
      ...
      <main className="flex-1 min-h-screen bg-dashboard-bg overflow-x-hidden">
        <div className="container mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-4 sm:pb-8">
          ...
          <div className="mb-6 sm:mb-8 flex items-center justify-center relative">
            <SidebarTrigger className="absolute left-0 h-9 w-9 sm:h-10 sm:w-10 rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm hover:bg-card transition-colors">
              <Menu className="h-5 w-5" />
            </SidebarTrigger>
            
            <div className="text-center">
              <h1 className="text-2xl sm:text-3xl font-bold text-foreground bg-gradient-to-r from-red-500 via-red-600 to-orange-600 bg-clip-text text-transparent">
                YouTube Dashboard
              </h1>
            </div>
